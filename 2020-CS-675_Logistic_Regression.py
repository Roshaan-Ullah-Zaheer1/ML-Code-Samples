...
CSV_Data.shape
X1 = CSV_Data.iloc[0:212,0:1]
X2 = CSV_Data.iloc[0:212,1:2]
X3 = CSV_Data.iloc[0:212,2:3]
X4 = CSV_Data.iloc[0:212,3:4]
X5 = CSV_Data.iloc[0:212,4:5]
X6 = CSV_Data.iloc[0:212,5:6]
X7 = CSV_Data.iloc[0:212,6:7]
Y = CSV_Data.iloc[0:212,-1] 
...
m,col = 212,7
ones = np.ones((m,1))
after_scaling_of_features = np.concatenate((ones,scale_x1,scale_x2,scale_x3,scale_x4,scale_x5,scale_x6,scale_x7), axis=1)
theta = np.zeros((8,1))
iterations = 100000
alpha = 0.01
...
testing_x1 = CSV_Data.iloc[212:,0:1]
testing_x2 = CSV_Data.iloc[212:,1:2]
testing_x3 = CSV_Data.iloc[212:,2:3]
testing_x4 = CSV_Data.iloc[212:,3:4]
testing_x5 = CSV_Data.iloc[212:,4:5]
testing_x6 = CSV_Data.iloc[212:,5:6]
testing_x7 = CSV_Data.iloc[212:,6:7]
testing_y = CSV_Data.iloc[212:,7:8]
